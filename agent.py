...
from tools.google_sheets_inquilinos_departamentos import buscar_pago_inquilino
...
tools = [
    ...
    buscar_pago_inquilino,          # Pago mensual del inquilino/propietario (Google Sheets)
]
